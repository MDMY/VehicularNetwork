...
import com.ding.serialException.SendDataToSerialPortFailure;
import com.ding.serialException.SerialPortInputStreamCloseFailure;
import com.ding.serialException.SerialPortOutputStreamCloseFailure;
...
public class SerialTool {
	...
	static{
		//在该类被ClassLoader加载时就初始化一个SerialTools对象
		if(serialTool==null){
